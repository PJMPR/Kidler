...
public class PersonRepository extends RepositoryBase <Person> implements IPersonRepository {
	...
	protected String createTableSql() {
		return "" + "CREATE TABLE Person("
				...
				+ "birthDate varchar(40)," + "personalIdentityNumber varchar(15),"
	...
	protected String insertSql() {
		...
		return "INSERT INTO person (name, surname, birthDate, personalIdentityNumber, phoneNumber, email) VALUES (?,?,?,?,?,?)";
	}
	...
	private String getSurnameSql() {
		// TODO Auto-generated method stub
		return "SELECT * FROM person where surname = ?";
	}
